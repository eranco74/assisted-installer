...
var getOpenshiftMapping = func(openshiftVersion string) map[string]string {
	openshiftVersionMap := map[string]map[string]string{
		...
		"4.6": {
			//rhcos: "https://mirror.openshift.com/pub/openshift-v4/dependencies/rhcos/4.5/4.5.2/rhcos-4.5.2-x86_64-metal.x86_64.raw.gz",
			...
			mco:   "quay.io/openshift-release-dev/ocp-v4.0-art-dev@sha256:460a2e0e44610ea6b88080020d1a2f3a04b1cd0f5826f9d93354eab9a768c347"}, // MCO for 4.6
	}
